...
# #         return render_template('index.html', corrected_text=corrected_text, corrected_grammar=corrected_grammar, grammar_count=grammar_count)

# @app.route('/spell', methods=['POST'])
# def spell():
#     text = request.json.get('text', '')  # Assuming you get the text from a POST request
#     corrected_grammar = spell_checker_module.correct_grammar(text)  # Only one return value
#     # Assuming you want to return this corrected grammar as a response
...
#         return render_template('index.html', corrected_file_text=corrected_file_text, corrected_file_grammar=corrected_file_grammar, grammar_count=grammar_count)
...
def spell():
    ...
    corrected_text = spell_checker_module.correct_spell(text)
    corrected_grammar = spell_checker_module.correct_grammar(text)
    # Return the corrected text and grammar to the rendered template
    return render_template('index.html', corrected_text=corrected_text, corrected_grammar=corrected_grammar)
